...
// ฟังก์ชันตรวจสอบและเปลี่ยนเส้นทางหากเป็นหน้าแรก
function redirectToIndexPage() {
 const currentPath = window.location.pathname;

 if (currentPath === '/Fan-Trove/' || currentPath === '/Fan-Trove') {
  // เปลี่ยนเส้นทางไปยัง index.html
  window.location.replace('/Fan-Trove/index.html');
 }
}

// เรียกใช้ฟังก์ชันโหลดภาษาเมื่อโหลดหน้า
window.onload = function() {
 redirectToIndexPage(); // ตรวจสอบและเปลี่ยนเส้นทางเมื่อเข้ามายังหน้าแรก
