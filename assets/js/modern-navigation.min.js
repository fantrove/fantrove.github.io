...
class ModernNavigation {
 ...
 /**
  * อัพเดทสถานะ active ของรายการนำทาง โดยปรับปรุงให้รองรับโฟลเดอร์
  * @private
  */
 _updateActiveState() {
  ...
  document.querySelectorAll(this.navItemSelector).forEach(item => {
   ...
   // สำหรับหน้าหลักให้ตรวจสอบให้ตรงกันแบบสมบูรณ์
   if (navLink === '/' || navLink === '/index.html') {
    item.classList.toggle(this.activeClass, currentPath === '/' || currentPath.endsWith('/index.html'));
   } else {
    // เช็คว่าส่วนแรกของ pathname ตรงกับ navLink หรือไม่
    // โดยให้แน่ใจว่า navLink มี trailing slash เพื่อป้องกัน case ที่เป็นชื่อเหมือนกัน
