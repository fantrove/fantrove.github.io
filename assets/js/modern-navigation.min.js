...
class ModernNavigation {
  ...
  _mountLeftRailIfNeeded(){
    ...
    // create site-main and move all body children except nav into it
    ...
    // sync CSS vars so other components (footer) know rail width
    ...
    // set nav to sticky and match CSS expectations
    nav.style.position = 'sticky';
    nav.style.top = '0';
    nav.style.height = '100vh';
    nav.style.left = '0';
    nav.style.transform = 'none';
    nav.style.zIndex = ''; // use natural stacking so it doesn't overlay
  }
