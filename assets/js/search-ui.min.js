/*
  search-ui-final.min.js (COMPLETE REDESIGN v6.1)
  ...
  - Clear separation: OVERLAY STATE vs SEARCH STATE
*/
(function () {
  'use strict';
  ...
  const SuggestionService = {
    ...
    renderQuerySuggestions: function(query) {
      ...
      for (let i = 0; i < suggestions.length; i++) {
        ...
        html += `<div class="suggestion-item" role="option" tabindex="0" data-val="${StringService.encodeUrl(s.raw)}" style="padding:8px 10px;border-top:1px solid #f4f6fa;cursor:pointer;display:flex;">
