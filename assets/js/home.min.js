// main.js - รองรับการอ่านข้อมูล json โครงสร้างใหม่ (type array) และรองรับหลายภาษาแบบสเกล
  ...
  database.type.forEach(typeObj => {
    ...
    categories.forEach(category => {
      ...
      (category.data || []).forEach(item => {
        ...
        // คลิกที่ card -> คัดลอก emoji/symbol พร้อมแสดง Notification (ใช้ API code แทน name)
          ...
          if (await copyToClipboard(copyText)) {
            ...
            if (typeof window.showCopyNotification === 'function') {
              window.showCopyNotification({
                text: copyText,
                name: item.api, // เปลี่ยนเป็นรหัส API
