...
async renderMainButtons() {
    ...
    for (const button of mainButtons) {
        ...
        mainButton.addEventListener('click', async (event) => {
            ...
            // --- Always clear active from all main buttons and set it to the clicked one ---
    ...
    async renderSubButtons(subButtons, mainButtonUrl, lang) {
        ...
        // ล้างปุ่มย่อยใหม่เสมอเมื่อเปลี่ยน main button
        ...
        subButtons.forEach(button => {
            ...
            // ปรับปรุงตรงนี้: คลิกปุ่มย่อยจะล้างเฉพาะเนื้อหา ไม่ล้าง/สร้างปุ่มย่อยใหม่
            subButton.addEventListener('click', async () => {
                ...
                // เปลี่ยน URL ด้วย (optional, ตามเดิม)
