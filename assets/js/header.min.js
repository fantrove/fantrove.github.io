...
(function() {
    ...
    (function createImmediateOverlay() {
        try {
            ...
            // minimal style matching overlay.js (so later removeInstantLoadingOverlay can remove it)
...
`;
            ...
            // force layout so it appears immediately
            overlay.offsetHeight;
            // expose removal hook so existing code can clear it later
            ...
            // small keyframe for spinner to animate in browsers where overlay.js animation not yet present
            try {
...
`;
    ...
    // --- End immediate overlay injection ---
