        ...
        try {
            ...
            if (mainButton.subButtons && mainButton.subButtons.length > 0) {
                ...
                if (mainChanged || !newSubRoute) {
                    ...
                    // main button และ sub route ยังไม่เปลี่ยนแปลง ไม่ต้องโหลดเนื้อหาใหม่
                }
            } else {
    ...
    createStickyStyles() {
        ...
        styleSheet.textContent = `
            ...
            #sub-nav::before {
                ...
                transition: all ${this.constants.ANIMATION_DURATION}ms cubic-bezier(0.4, 0, 0.2, 1);
                z-index: -1;
                opacity: 1;
            }
            ...
            #sub-nav.fixed::before {
                opacity: 1;
            }

            /* Animation states */
            #sub-nav.fixed.animate::before {
                left: 0;
                right: 0;
                border-radius: 0 0 15px 15px;
            }

            #sub-nav.unfixing::before {
                left: 0;
                right: 0;
                opacity: 1;
                border-radius: 0 0 15px 15px;
            ...
            #sub-nav.unfixing.animate::before {
                left: 20px;
                right: 20px;
                opacity: 1;
                border-radius: 25px;
