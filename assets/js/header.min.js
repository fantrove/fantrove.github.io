...
// โค้ดฟังก์ชันที่ปรับปรุงแล้ว ไม่เซ็ต style.transition ใน JS เพื่อให้ CSS จัดการ transition และ hover animation ได้ครบ
...
async createButton(config) {
    ...
    // Animation fade-in (ใช้แต่ CSS)
    button.classList.add('fade-in');
    button.style.opacity = 0;
    // ** ไม่ต้องเซ็ต style.transition ใน JS **
