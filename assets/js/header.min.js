...
(function immediateLoadingOverlay() {
    ...
    // Remove overlay after app is initialized
...
const initializeApp = async () => {
    ...
    try {
        ...
        // [NEW CODE] Remove the instant loading overlay
        if (window.__removeInstantLoadingOverlay) window.__removeInstantLoadingOverlay();
    }
};
