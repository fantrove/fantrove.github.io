...
const SYSTEM_CONFIG = Object.freeze({
  ...
  preloadTimeout: 300,
  displayDuration: 3300, // 3.3 วินาที
});
...
class IntroTemplateManager {
  ...
  async prepare() {
    ...
    try {
      ...
      // สร้าง wrapper สำหรับ content
      const contentWrapper = document.createElement('div');
      contentWrapper.classList.add('intro-content');
      contentWrapper.innerHTML = template;
      
      // เคลียร์ container ก่อนใส่ content ใหม่
      container.innerHTML = '';
  ...
  hide() {
    ...
    const fadeOutPromise = new Promise(resolve => {
      const handleAnimationEnd = () => {
        this.container.removeEventListener('transitionend', handleAnimationEnd);
        resolve();
      };
      
      this.container.addEventListener('transitionend', handleAnimationEnd, { once: true });
