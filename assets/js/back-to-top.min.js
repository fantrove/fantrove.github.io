document.addEventListener('DOMContentLoaded', () => {
 ...
 const SETTINGS = {
  SCROLL_THRESHOLD: 120, // ระยะที่ต้องเลื่อนลงก่อนแสดงปุ่ม (px)
  ...
  SAFE_ZONE: 120, // ระยะปลอดภัยที่ไม่ต้องแสดงปุ่ม (px)
  ...
  VIBRATION_DURATION: 40 // ระยะเวลาการสั่น (ms) สามารถปรับตรงนี้
 };
