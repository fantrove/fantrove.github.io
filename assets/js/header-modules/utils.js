...
export function showNotification(message, type = 'info', options = {}) {
 ...
 try {
  ...
  if (!document.querySelector('#notification-styles')) {
   ...
   style.textContent = `
                .notification { position: fixed; top: 20px; right: 20px; padding: 16px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.08); z-index: 10000; opacity: 0; transform: translateY(-10px); animation: slideIn 0.25s ease forwards; display:flex; align-items:center; gap:12px; min-width:240px; max-width:420px; }
                ...
                .notification-icon { background: rgba(255,255,255,0.12); width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 18px; flex: 0 0 auto; }
                ...
                .notification-close { background: none; border: none; color: white; font-size: 20px; cursor: pointer; padding: 0; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; margin-left:8px; }
