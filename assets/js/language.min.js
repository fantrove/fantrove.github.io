 ...
 * @version 2.5.0
 *
 * เวอร์ชั่นนี้ได้รับการปรับปรุงเพื่อให้ระบบแปลภาษาและอัพเดท <html> attribute lang ทันที
 * โดยการเอา delay ออกทั้งหมดและใช้เทคนิคขั้นสูงระดับองค์กรในการประมวลผล
 * - ไม่มีการรอ delay (UPDATE_DELAY ตั้งค่าเป็น 0)
 * - ใช้ microtask scheduling (Promise.resolve().then(...)) เพื่อให้การอัพเดท DOM เกิดขึ้นทันที
 * - ปรับปรุงการประมวลผล MutationObserver โดย throttle ด้วยเวลาเพียงเล็กน้อย (50ms) สำหรับการรวบรวม
 *
