 ...
 * @version 2.5.2
 *
 * เวอร์ชั่นนี้ได้รับการปรับปรุงให้ระบบมีการออกแบบอย่างชาญฉลาดขึ้น
 * โดยเมื่อระบบตรวจพบว่า ภาษาในเว็บไซต์ (หรือภาษาที่ผู้ใช้เลือก) ตรงกับภาษาที่เบราว์เซอร์ตั้งไว้
 * และภาษานั้นมีอยู่ในฐานข้อมูล (languagesConfig) ระบบจะเพิ่ม attribute translate="no"
 * พร้อมทั้งเพิ่ม meta tag (เช่น <meta name="google" content="notranslate">) ใน <head> เพื่อบล็อค
 * การแปลแบบอัตโนมัติจาก browser และเครื่องมืออื่นๆ
 *
 * แต่ถ้าภาษาที่เว็บไซต์เลือกไม่ตรงกับภาษาของเบราว์เซอร์ (เช่น ระบบเลือกภาษาอังกฤษแทน)
 * ระบบจะไม่เพิ่ม attribute translate="no" หรือ meta tagบล็อคการแปล เพื่อให้สามารถแปลได้ตามปกติ
 *
 * ระบบการจัดการภาษา ยังคงใช้ข้อมูลจาก IndexedDB สำหรับ DSL และ JSON config
 * โดย attribute lang ใน <html> ยังคงถูกจัดการโดยระบบของเราเท่านั้น
 */
