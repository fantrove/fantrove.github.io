 ...
 * @version 2.3.1
 *
 * เวอร์ชั่นนี้มีการปรับปรุงให้ระบบเซฟ languagesConfig 
 * (หรือข้อมูลที่โหลดมาจากไฟล์ JSON) ไว้ใน IndexedDB แทนที่จะเซฟไว้ที่ LocalStorage
 * (รหัสภาษาที่ผู้ใช้เลือกยังคงถูกเก็บใน LocalStorage ตามเดิม)
 */
